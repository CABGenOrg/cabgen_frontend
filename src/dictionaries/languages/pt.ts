const pt = {
  ...
  About: {
    ...
    Team: {
      ...
      roleNicolas: "Responsável pelo desenvolvimento da nova versão do CABGen.",
    },
    AboutContact: {
...
identifiedSpecies: "Espécie Identificada",
          ...
          plasmid: "Plasmídeo",
          desc: {
            completeness: "Porcentagem de completude do genoma montado",
            n50: "Maior contig onde metade dos nucleotídeos estão em contigs maiores ou iguais",
            genomeSize: "Tamanho total do genoma em pares de bases",
            coverage: "Profundidade média de cobertura do sequenciamento",
            contamination: "Nível de contaminação estimado",
            identifiedSpecies: "Espécie identificada pelo pipeline",
            secondarySpecies: "Espécie secundária, exibida quando o limite de contaminação é superado",
            mlst: "Perfil de sequência multi-locus atribuído ao isolado",
            acquiredResistance: "Genes de resistência adquirida detectados",
            poliMutations: "Mutações associadas à resistência a polimixinas",
            otherMutations: "Outras mutações de interesse clínico detectadas",
            plasmid: "Plasmídeos identificados no genoma",
            vfdb: "Fatores de virulência detectados",
          },
        },
    ...
    admin: {
      ...
      audit: {
        ...
        date: "Data",
        metadata: "Metadados",
        filterBySource: "Buscar por Fonte...",
        filterByStatus: "Buscar por Status...",
        filterByDate: "Filtrar por Data",
        filterByUser: "Filtrar por Usuário",
        filterByEvent: "Filtrar por Evento",
        noAudit: "Nenhum registro de auditoria encontrado",
