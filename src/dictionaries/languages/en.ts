const en = {
  ...
  About: {
    ...
    Team: {
      ...
      roleNicolas: "Responsible for developing the new version of CABGen.",
    },
    AboutContact: {
...
identifiedSpecies: "Identified Species",
          ...
          plasmid: "Plasmid",
          desc: {
            completeness: "Percentage of completeness of the assembled genome",
            n50: "Largest contig where half the nucleotides are in contigs of equal or greater length",
            genomeSize: "Total genome size in base pairs",
            coverage: "Average sequencing coverage depth",
            contamination: "Estimated contamination level",
            identifiedSpecies: "Species identified by the pipeline",
            secondarySpecies: "Secondary species, shown when the contamination threshold is exceeded",
            mlst: "Multi-locus sequence type assigned to the isolate",
            acquiredResistance: "Detected acquired resistance genes",
            poliMutations: "Mutations associated with polymyxin resistance",
            otherMutations: "Other clinically relevant mutations detected",
            plasmid: "Plasmids identified in the genome",
            vfdb: "Detected virulence factors",
          },
        },
    ...
    admin: {
      ...
      audit: {
        ...
        date: "Date",
        metadata: "Metadata",
        filterBySource: "Search by Source...",
        filterByStatus: "Search by Status...",
        filterByDate: "Filter by Date",
        filterByUser: "Filter by User",
        filterByEvent: "Filter by Event",
        noAudit: "No audit records found",
        showingAudit: "{count} records",
