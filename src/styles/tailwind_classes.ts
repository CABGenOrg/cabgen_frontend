export const section_title = "font-bold 2xl:text-6xl md:text-5xl text-3xl";
...
export const input_class =
  "block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm placeholder:text-gray-400 focus:ring-2 focus:ring-cabgen-200 focus:outline-none 2xl:text-xl sm:text-base sm:leading-6";
export const label_class =
  "block 2xl:text-2xl text-lg font-light tracking-wider leading-6 text-gray-900";
